...
`modernerKrieg` keeps the simulation core portable and headless. Native platform frontends, Mosul content, renderer helpers, autoplay tools, and AI policies sit above that core.
